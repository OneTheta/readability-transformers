...
from .AdvancedSemantic import WoKF as AdSem_WoKF
from .AdvancedSemantic import WBKF as AdSem_WBKF
from .AdvancedSemantic import OSKF as AdSem_OSKF
from .AdvancedSemantic import CKKF as AdSem_CKKF

# discourse features
from .Discourse import EnDF as Disco_EnDF
from .Discourse import EnGF as Disco_EnGF

# syntactic features
from .Syntactic import POSF as Synta_POSF
from .Syntactic import PhrF as Synta_PhrF
from .Syntactic import TrSF as Synta_TrSF

# lexico-Semantic features
from .LexicoSemantic import TTRF as LxSem_TTRF
from .LexicoSemantic import VarF as LxSem_VarF
from .LexicoSemantic import PsyF as LxSem_PsyF
from .LexicoSemantic import WorF as LxSem_WorF

# shallow features
from .ShallowTraditional import ShaF as ShaTr_ShaF
from .ShallowTraditional import TraF as ShaTr_TraF
...
class pass_text:
    ...
    ** throughout this program, only n_token and n_sent are defaulted at 1 to prevent division error
    ...
    output (type -> dictionary): 
    - CRich05_S: Semantic Richness, 50 topics extracted from CoKEC Corpus
    - CClar05_S: Semantic Clarity, 50 topics extracted from CoKEC Corpus
    - CNois05_S: Semantic Noise, 50 topics extracted from CoKEC Corpus
    - CTopc05_S: Number of topics, 50 topics extracted from CoKEC Corpus
    - CRich10_S: Semantic Richness, 100 topics extracted from CoKEC Corpus
    - CClar10_S: Semantic Clarity, 100 topics extracted from CoKEC Corpus
    - CNois10_S: Semantic Noise, 100 topics extracted from CoKEC Corpus
    - CTopc10_S: Number of topics, 100 topics extracted from CoKEC Corpus
    - CRich15_S: Semantic Richness, 150 topics extracted from CoKEC Corpus
    - CClar15_S: Semantic Clarity, 150 topics extracted from CoKEC Corpus
    - CNois15_S: Semantic Noise, 150 topics extracted from CoKEC Corpus
    - CTopc15_S: Number of topics, 150 topics extracted from CoKEC Corpus
    - CRich20_S: Semantic Richness, 200 topics extracted from CoKEC Corpus
    - CClar20_S: Semantic Clarity, 200 topics extracted from CoKEC Corpus
    - CNois20_S: Semantic Noise, 200 topics extracted from CoKEC Corpus
    - CTopc20_S: Number of topics, 200 topics extracted from CoKEC Corpus
    """
    def CKKF_(self):
        result = AdSem_CKKF.retrieve(self.token_list, dir_path)
        result = nan_check(result)
        return result
